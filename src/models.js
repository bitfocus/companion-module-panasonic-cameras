...
export const SERIES_SPECS = [
...

	{
		...
		capabilities: {
			...
			poll: { ptz: ['GF', 'GI', 'GZ'], cam: ['QAF', 'QAW', 'QBR', 'QBP', 'QFT', 'QGU', 'QIS', 'QLR', 'QLG', 'QRP', 'QSD:4F', 'QSD:B0', 'QSG:39', 'QSG:3A', 'QSI:20', 'QSJ:0F', 'QSJ:10'], web: ['get_state'] },
			power: false,
			preset: false,
			presetSpeed: false,
...

	{
		...
		capabilities: {
			...
			presetThumbnails: false,
			presetTime: false,
			pull: { ptz: ['O', 'PE00', 'PE01', 'PE02', 'DA', 'INS', 'LPI', 'PST', 'RER', 'S', 'UPVS'], cam: ['QAF', 'QAW', 'QBR', 'QGB', 'QGU', 'QIS', 'QGR', 'QRS', 'QSH', 'QTD', 'QSD:4F', 'QSD:B1', 'QSE:71'], web: false },
			recordSD: true,
			restart: true,
...

	{
		...
		capabilities: {
			...
			presetThumbnails: true,
			presetTime: true,
			pull: { ptz: false, cam: ['QSL:B6', 'QSL:B7', 'QSL:BB'], web: false }, // ToDo
			recordSD: false,
			restart: true,
...

	{
		...
		capabilities: {
			...
			panTilt: true,
			pedestal: { cmd: 'OSJ:0F', offset: 0x800, limit: 200, step: 1, hexlen: 3 },
			poll: { ptz: false, cam: ['QIF', 'QSD:B0', 'QSJ:10'], web: ['get_rtmp_status', 'get_srt_status', 'get_ts_status'] },
			power: true,
			preset: 100,
			presetSpeed: { dropdown: e.ENUM_PRESET_SPEED_TABLE_2 },
			presetThumbnails: true,
