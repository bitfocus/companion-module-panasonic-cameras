...
export const SERIES_SPECS = [
	{
		...
		capabilities: {
			...
			dnr: { cmd: 'OSD:3A', dropdown: e.ENUM_DNR }, // Has Digital Noise Reduction (OSD:3A)
			drs: { cmd: 'OSE:33', dropdown: e.ENUM_DRS }, // Has Dynamic Range Stretch (OSE:33)
...

	{
		...
		capabilities: {
			...
			colorbar: true,
			dnr: { cmd: 'OSD:3A', dropdown: e.ENUM_DNR },
			drs: { cmd: 'OSE:33', dropdown: e.ENUM_DRS_OFF_LOW_HIGH },
			error: true,
			filter: false,
			focus: true,
			focusAuto: true,
...

	{
		...
		capabilities: {
			...
			colorbar: true,
			dnr: { cmd: 'OSD:3A', dropdown: e.ENUM_DNR },
			drs: { cmd: 'OSE:33', dropdown: e.ENUM_DRS },
			error: true,
			filter: { dropdown: e.ENUM_FILTER_3 },
			focus: true,
			focusAuto: true,
...

	{
		...
		capabilities: {
			...
			colorbar: true,
			dnr: { cmd: 'OSD:3A', dropdown: e.ENUM_DNR_OFF_ON },
			drs: false,
			error: true,
			filter: { dropdown: e.ENUM_FILTER_3 },
			focus: false,
...

	{
		...
		capabilities: {
			...
			colorbar: true,
			dnr: { cmd: 'OSD:3A', dropdown: e.ENUM_DNR },
			drs: { cmd: 'OSE:33', dropdown: e.ENUM_OFF_ON },
			error: true,
			filter: false,
			focus: false,
			focusAuto: false,
...

	{
		...
		capabilities: {
			chromaLevel: { cmd: 'OCG', dropdown: e.ENUM_CHROMA_LEVEL_3 },
			chromaPhase: { cmd: 'OSJ:0B', dropdown: e.ENUM_CHROMA_PHASE_31 },
			colorGain: { cmd: { red: 'OSG:39', blue: 'OSG:3A' }, offset: 0x800, limit: 200, step: 1, hexlen: 3 },
			colorPedestal: false,
			colorTemperature: { advanced: { inc: 'OSI:1E', dec: 'OSI:1F', set: 'OSI:20', min: 2000, max: 15000 } },
			colorbar: true,
